...
public class ConnectionRope : Rope
{
    ...
    void Update()
    {
        ...
        {
            ModifyLength(ConnectedBody.transform.position);
    ...
    public float GetDistanceBetweenBodies() => (transform.position - ConnectedBody.transform.position).magnitude;
    ...
    protected override void ApplyConstraint()
    {
        ...
        endSegment.posNow = ConnectedBody.transform.position;
